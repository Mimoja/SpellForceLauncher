========================================================================
    KONSOLENANWENDUNG: SpellforceLauncher-Projektübersicht
========================================================================

Diese SpellforceLauncher-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre SpellforceLauncher-Anwendung besteht.


SpellforceLauncher.vcxproj
...
SpellforceLauncher.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen SpellforceLauncher.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
